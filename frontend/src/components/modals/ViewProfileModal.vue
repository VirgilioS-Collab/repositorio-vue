...
<template>
  <div class="bg-white rounded-lg w-full max-w-lg shadow-xl">
    ...
    <div class="p-6 space-y-4 max-h-[60vh] overflow-y-auto">
      ...
      <div>
        <label class="block text-sm font-medium text-gray-700">Acerca de mí</label>
        <textarea 
          v-model="form.about_me"
          rows="3"
          class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:border-accent focus:ring focus:ring-accent focus:ring-opacity-50"
        ></textarea>
      </div>
    </div>
